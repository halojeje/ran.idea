...
class RanIdeaDataset {
  ...
  static RanIdeaItem generateRandomIdea() {
    ...
    return RanIdeaItem(
      ...
      tipeOutput: tipeOutput[rand.nextInt(tipeOutput.length)],
      temaIde: temaIde[rand.nextInt(temaIde.length)],
      supergraphics: supergraphics[rand.nextInt(supergraphics.length)],
      mainDesignStyle: mainDesignStyle[rand.nextInt(mainDesignStyle.length)],
      colorPaletteHex: colorPalettes[rand.nextInt(colorPalettes.length)],
    );
  }
}
